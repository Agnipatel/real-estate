    ...
    <section id="why-us" className="py-24 bg-slate-950 relative">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6">Smarter Real Estate Marketing <span className="text-green-500">Starts Here</span></h2>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 md:p-10"
          >
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-4">Results-Focused Lead Generation</h3>
            <p className="text-sm sm:text-base text-gray-400 mb-8">We don t focus only on impressions and clicks. As a leading real estate advertising company, we focus on:</p>
        ...
        <div className="flex justify-center mt-12">
          ...
          >
            <span className="break-words">Request Your Free Lead Generation Audit</span>
            <ArrowRight
