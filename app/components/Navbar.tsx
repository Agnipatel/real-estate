  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="flex items-center text-2xl font-bold text-white tracking-tighter"
        >
          <Image
            src="/logo.png"
            alt="PANDAeCe Logo"
        ...
        >
          <div className="flex flex-col px-6 py-4 space-y-4">
            ...
            <Link
              href="/#contact"
              onClick={() => setMobileMenuOpen(false)}
              className="bg-green-600 hover:bg-green-700 text-center text-white px-6 py-3 rounded-md font-medium transition-all"
            >
              Free Audit
            </Link>
          </div>
